...
# Simple token transfer script for UBI Chain
# This script uses a hardcoded value to avoid formatting issues
...
echo -e "${GREEN}UBI Chain - Simple Token Transfer${NC}"
echo "This script sends 100 UBI tokens to your MetaMask address."
echo
...
echo -e "${YELLOW}Sending 100 UBI tokens to $TO_ADDRESS...${NC}"

# Create a JSON-RPC request with hardcoded value
...
if echo $RESPONSE | grep -q "result"; then
    ...
    echo -e "Tokens sent: ${YELLOW}100 UBI${NC}"
